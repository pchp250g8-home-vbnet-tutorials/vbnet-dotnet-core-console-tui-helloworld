...
The program does the following:
  ...
  4. Displays the second inscription "VB.Net DotNet Core Platform!!!" in column 10 and row 11.
  5. Waiting for a key to be pressed.
  6. Exits.

HelloWorld. Занятия по VB.Net. Платформа DotNet Core. Приложение с текстовым интерфейсом пользователя. Расшеренные возможности консоли. Консольное приложение.
Программа делает следующее:
  ...
  4. Выводит на экран вторую надпись "VB.Net DotNet Core Platform!!!" в 10 столбце и 11 строке.
